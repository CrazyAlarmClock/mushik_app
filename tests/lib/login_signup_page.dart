  ...
  void _showVerifyEmailSentDialog() {
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title: new Text("Подтвердите ваш аккаунт"),
          content: new Text("Ссылка подтверждения аккаунта отправлена на вашу почту"),
          actions: <Widget>[
            new FlatButton(
  ...
  Widget _showSecondaryButton() {
    return new FlatButton(
      child: _formMode == FormMode.LOGIN
          ? new Text('Нет аккаунта? Создать аккаунт',
          style: new TextStyle(fontSize: 18.0, fontWeight: FontWeight.w300))
          : new Text('Есть аккаунт? Войти',
          style:
